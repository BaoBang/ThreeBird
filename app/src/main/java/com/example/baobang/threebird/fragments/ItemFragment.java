...
public class ItemFragment extends Fragment {
    ...
    private TextView txtResult, txtNumber1, txtNumber2, txtNumber3;
...
//        model2 = (Model2) savedInstanceState.getSerializable("MODEL2");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        txtNumber1 = view.findViewById(R.id.txtNumber1);
        txtNumber2 = view.findViewById(R.id.txtNumber2);
        txtNumber3 = view.findViewById(R.id.txtNumber3);
        layout = view.findViewById(R.id.layout);
        Model2 model2 = (Model2)  getArguments().getSerializable("MODEL2");
       // Model2 model2  = new Model2(3, "MỚI", 100,20000,30000);

        txtResult.setText(model2.getResult());
        txtNumber1.setText(model2.getNumber1() + "");
        txtNumber2.setText(model2.getNumber2() + "đ");
        txtNumber3.setText(model2.getNumber3() + "đ");
        switch (model2.getColor()){
            case 1:
